...
namespace HotelReservationProject.WebUI.Controllers
{
	public class AdminAboutController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			var responseMessage = await client.GetAsync("http://localhost:33170/api/About");
		...
		public async Task<IActionResult> UpdateAbout(int id)
		{
			...
			var responseMessage = await client.GetAsync($"http://localhost:33170/api/About/{id}");
		...
		public async Task<IActionResult> UpdateAbout(UpdateAboutDto model)
		{
			...
			var responseMessage = await client.PutAsync("http://localhost:33170/api/About", stringContent);
