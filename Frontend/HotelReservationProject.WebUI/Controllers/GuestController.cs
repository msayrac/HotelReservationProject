...
namespace HotelReservationProject.WebUI.Controllers
{
	public class GuestController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			var responseMessage = await client.GetAsync("http://localhost:33170/api/Guest");
		...
		public async Task<IActionResult> AddGuest(CreateGuestDto createGuestDto)
		{
			...
			var responseMessage = await client.PostAsync("http://localhost:33170/api/Guest", stringContent);
			if (responseMessage.IsSuccessStatusCode)
			{
		...
		{
			var client = _httpClientFactory.CreateClient();
			var responseMessage = await client.DeleteAsync($"http://localhost:33170/api/Guest/{id}");
		...
		public async Task<IActionResult> UpdateGuest(int id)
		{
			...
			var responseMessage = await client.GetAsync($"http://localhost:33170/api/Guest/{id}");
		...
		public async Task<IActionResult> UpdateGuest(UpdateGuestDto updateGuestDto)
		{
			...
			var responseMessage = await client.PutAsync("http://localhost:33170/api/Guest", stringContent);
